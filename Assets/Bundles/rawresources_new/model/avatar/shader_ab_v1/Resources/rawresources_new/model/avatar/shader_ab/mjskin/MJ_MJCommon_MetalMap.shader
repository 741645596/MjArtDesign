...
#pragma exclude_renderers d3d11
      #pragma multi_compile DIRECTIONAL _SPECULAR_ON _CUSTOMCUBE_ON
      //#pragma target 4.0
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_500 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_500, _tmp_dvx_500, _tmp_dvx_500, _tmp_dvx_500);
          ...
          float3 cubeVar_28;
          float3 reflectDir_29;
          float3 rimLightDirection_30;
          float3 col_31;
          float D_32;
          float V_33;
          float3 diffuseTerm_34;
          float roughness_35;
          float perceptualRoughness_36;
          float3 h_37;
          float tmpvar_38;
          tmpvar_38 = clamp(dot(normal_26, _WorldSpaceLightPos0.xyz), 0, 1);
          float3 tmpvar_39;
          tmpvar_39 = normalize((_WorldSpaceLightPos0.xyz + viewDir_27));
          h_37 = tmpvar_39;
          float tmpvar_40;
          float tmpvar_41;
          tmpvar_41 = clamp(dot(normal_26, h_37), 0, 1);
          tmpvar_40 = tmpvar_41;
          float tmpvar_42;
          tmpvar_42 = abs(dot(normal_26, viewDir_27));
          float tmpvar_43;
          float tmpvar_44;
          tmpvar_44 = clamp(dot(_WorldSpaceLightPos0.xyz, h_37), 0, 1);
          tmpvar_43 = tmpvar_44;
          float tmpvar_45;
          float smoothness_46;
          smoothness_46 = tmpvar_9;
          tmpvar_45 = (1 - smoothness_46);
          perceptualRoughness_36 = tmpvar_45;
          float tmpvar_47;
          float perceptualRoughness_48;
          perceptualRoughness_48 = perceptualRoughness_36;
          tmpvar_47 = (perceptualRoughness_48 * perceptualRoughness_48);
          roughness_35 = tmpvar_47;
          float3 tmpvar_49;
          float _tmp_dvx_501 = ((tmpvar_38 * 0.5) + 0.5);
          tmpvar_49 = float3(_tmp_dvx_501, _tmp_dvx_501, _tmp_dvx_501);
          diffuseTerm_34 = tmpvar_49;
          float tmpvar_50;
          float NdotL_51;
          NdotL_51 = tmpvar_38;
          float NdotV_52;
          NdotV_52 = tmpvar_42;
          float roughness_53;
          roughness_53 = roughness_35;
          tmpvar_50 = (0.5 / (((NdotL_51 * ((NdotV_52 * (1 - roughness_53)) + roughness_53)) + (NdotV_52 * ((NdotL_51 * (1 - roughness_53)) + roughness_53))) + 1E-05));
          V_33 = tmpvar_50;
          float tmpvar_54;
          float NdotH_55;
          NdotH_55 = tmpvar_40;
          float roughness_56;
          roughness_56 = roughness_35;
          float tmpvar_57;
          tmpvar_57 = (roughness_56 * roughness_56);
          float tmpvar_58;
          tmpvar_58 = ((((NdotH_55 * tmpvar_57) - NdotH_55) * NdotH_55) + 1);
          tmpvar_54 = ((0.3183099 * tmpvar_57) / ((tmpvar_58 * tmpvar_58) + 1E-07));
          D_32 = tmpvar_54;
          float3 tmpvar_59;
          tmpvar_59 = clamp(tmpvar_4, 0, 1);
          float x_60;
          x_60 = (1 - tmpvar_43);
          rimLightDirection_30 = in_f.xlv_TEXCOORD9;
          col_31 = (((clamp(tmpvar_4, 0, 1) * (((_GiColor * _IndirectDiffuseIntensity) * _MetallicMapIndirectDiffuseIntensity).xyz + (diffuseTerm_34 * _DirectLightIntensity))) + ((max(0, ((V_33 * D_32) * (3.141593 * tmpvar_38))) * (tmpvar_59 + ((1 - tmpvar_59) * ((x_60 * x_60) * ((x_60 * x_60) * x_60))))) * _DirectSpecularScale)) + clamp(((_RimColor.xyz * clamp(pow(((1 - tmpvar_38) * clamp(dot(normal_26, rimLightDirection_30), 0, 1)), _RimPower), 0, 1)) * _RimIntensity), 0, 1));
          float _tmp_dvx_502 = clamp(pow((1 - tmpvar_42), 5), 0, 1);
          float _tmp_dvx_503 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_31 = (col_31 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_35) * perceptualRoughness_36))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_503, _tmp_dvx_503, _tmp_dvx_503), float3(_tmp_dvx_502, _tmp_dvx_502, _tmp_dvx_502))) * _InDirectLightIntensity));
          float3 tmpvar_61;
          tmpvar_61 = (viewDir_27 - (2 * (dot(normal_26, viewDir_27) * normal_26)));
          reflectDir_29 = tmpvar_61;
          float3 tmpvar_62;
          tmpvar_62 = texCUBE(_Cubemap, reflectDir_29).xyz;
          cubeVar_28 = tmpvar_62;
          col_31 = (((0.3 * (1 - tmpvar_10)) * cubeVar_28) + (lerp(0.9, 1, tmpvar_10) * lerp((_AOColor.xyz * col_31), col_31, gmVar_5.zzz)));
          float4 tmpvar_63;
          tmpvar_63 = tex2D(_Emission, in_f.xlv_TEXCOORD0);
          col_31 = (col_31 + (tmpvar_63.xyz * _EmissionScale));
          float4 tmpvar_64;
          tmpvar_64.xyz = float3(clamp((col_31 * tmpvar_19), 0, 1));
          tmpvar_64.w = tmpvar_8;
          final_col_2.xyz = tmpvar_64.xyz;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_504 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_504, _tmp_dvx_504, _tmp_dvx_504, _tmp_dvx_504);
          envSample_21 = tmpvar_24;
          float4 data_25;
          data_25 = envSample_21;
          float3 normal_26;
          ...
          float3 tmpvar_47;
          float _tmp_dvx_505 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_505, _tmp_dvx_505, _tmp_dvx_505);
          ...
          float _tmp_dvx_506 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_507 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_507, _tmp_dvx_507, _tmp_dvx_507), float3(_tmp_dvx_506, _tmp_dvx_506, _tmp_dvx_506))) * _InDirectLightIntensity));
          float3 tmpvar_59;
