...
Shader "MJ/MJCommon_MetalMapTransparentCullBack"
{
  Properties
  {
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_23 = tmpvar_24;
          float4 tmpvar_25;
          float _tmp_dvx_539 = texCUBE(custom_SpecCube, R_23);
          tmpvar_25 = float4(_tmp_dvx_539, _tmp_dvx_539, _tmp_dvx_539, _tmp_dvx_539);
          ...
          float3 tmpvar_48;
          float _tmp_dvx_540 = ((tmpvar_37 * 0.5) + 0.5);
          tmpvar_48 = float3(_tmp_dvx_540, _tmp_dvx_540, _tmp_dvx_540);
          ...
          float _tmp_dvx_541 = clamp(pow((1 - tmpvar_41), 5), 0, 1);
          float _tmp_dvx_542 = clamp((tmpvar_9 + (1 - tmpvar_19)), 0, 1);
          col_30 = (col_30 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_26.w - 1)) + 1)) * data_26.xyz)) * (1 - ((0.28 * roughness_34) * perceptualRoughness_35))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_18, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_542, _tmp_dvx_542, _tmp_dvx_542), float3(_tmp_dvx_541, _tmp_dvx_541, _tmp_dvx_541))) * _InDirectLightIntensity));
          float3 tmpvar_60;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_543 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_543, _tmp_dvx_543, _tmp_dvx_543, _tmp_dvx_543);
          ...
          float3 tmpvar_47;
          float _tmp_dvx_544 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_544, _tmp_dvx_544, _tmp_dvx_544);
          ...
          float _tmp_dvx_545 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_546 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_546, _tmp_dvx_546, _tmp_dvx_546), float3(_tmp_dvx_545, _tmp_dvx_545, _tmp_dvx_545))) * _InDirectLightIntensity));
          float3 tmpvar_59;
