...
Shader "URP/Realtime/Scene/Unlit_Alpha_ReceiveShadow"
{
  Properties
  {
    _MainTex ("Base Map", 2D) = "white" {}
    _Color ("Base Color", Color) = (1,1,1,1)
    _ColorScale ("Color Scale", Range(0.1, 10)) = 1
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d = (u_xlat16_1 * _Color);
          u_xlat2.xyz = ((u_xlat1_d.xyz * float3(_ColorScale, _ColorScale, _ColorScale)) + (-_ShadowColor.xyz));
