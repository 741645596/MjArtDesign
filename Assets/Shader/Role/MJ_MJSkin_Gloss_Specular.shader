...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float _tmp_dvx_34 = (gst_6.z * _ScatteringMapScale);
          tmpvar_4 = float3(_tmp_dvx_34, _tmp_dvx_34, _tmp_dvx_34);
          ...
          tmpvar_31 = tmpvar_30;
          float3 tmpvar_32;
          float _tmp_dvx_35 = ((tmpvar_27 * 0.5) + 0.5);
          tmpvar_32 = (_DiffuseIntensity * (tmpvar_31 + lerp(_AttenColor, float4(1, 1, 1, 1), float4(_tmp_dvx_35, _tmp_dvx_35, _tmp_dvx_35, _tmp_dvx_35)).xyz));
          col_21 = tmpvar_32;
