...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_36;
          float _tmp_dvx_13 = ((tmpvar_25 * 0.5) + 0.5);
          tmpvar_36 = float3(_tmp_dvx_13, _tmp_dvx_13, _tmp_dvx_13);
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_35;
          float _tmp_dvx_14 = ((tmpvar_24 * 0.5) + 0.5);
          tmpvar_35 = float3(_tmp_dvx_14, _tmp_dvx_14, _tmp_dvx_14);
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          roughness_21 = tmpvar_33;
          float3 tmpvar_35;
          float _tmp_dvx_15 = ((tmpvar_24 * 0.5) + 0.5);
          tmpvar_35 = float3(_tmp_dvx_15, _tmp_dvx_15, _tmp_dvx_15);
          diffuseTerm_20 = tmpvar_35;
          float tmpvar_36;
          float NdotL_37;
          NdotL_37 = tmpvar_24;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          roughness_21 = tmpvar_33;
          float3 tmpvar_35;
          float _tmp_dvx_16 = ((tmpvar_24 * 0.5) + 0.5);
          tmpvar_35 = float3(_tmp_dvx_16, _tmp_dvx_16, _tmp_dvx_16);
          diffuseTerm_20 = tmpvar_35;
          float tmpvar_36;
          float NdotL_37;
          NdotL_37 = tmpvar_24;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_34;
          float _tmp_dvx_17 = ((tmpvar_23 * 0.5) + 0.5);
          tmpvar_34 = float3(_tmp_dvx_17, _tmp_dvx_17, _tmp_dvx_17);
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          roughness_20 = tmpvar_32;
          float3 tmpvar_34;
          float _tmp_dvx_18 = ((tmpvar_23 * 0.5) + 0.5);
          tmpvar_34 = float3(_tmp_dvx_18, _tmp_dvx_18, _tmp_dvx_18);
          diffuseTerm_19 = tmpvar_34;
          float tmpvar_35;
          float NdotL_36;
          NdotL_36 = tmpvar_23;
