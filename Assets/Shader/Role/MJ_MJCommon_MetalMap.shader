...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_5 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_5, _tmp_dvx_5, _tmp_dvx_5, _tmp_dvx_5);
          ...
          float3 tmpvar_49;
          float _tmp_dvx_6 = ((tmpvar_38 * 0.5) + 0.5);
          tmpvar_49 = float3(_tmp_dvx_6, _tmp_dvx_6, _tmp_dvx_6);
          ...
          float _tmp_dvx_7 = clamp(pow((1 - tmpvar_42), 5), 0, 1);
          float _tmp_dvx_8 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_31 = (col_31 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_35) * perceptualRoughness_36))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_8, _tmp_dvx_8, _tmp_dvx_8), float3(_tmp_dvx_7, _tmp_dvx_7, _tmp_dvx_7))) * _InDirectLightIntensity));
          float3 tmpvar_61;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_9 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_9, _tmp_dvx_9, _tmp_dvx_9, _tmp_dvx_9);
          envSample_21 = tmpvar_24;
          float4 data_25;
          data_25 = envSample_21;
          float3 normal_26;
          ...
          float3 tmpvar_47;
          float _tmp_dvx_10 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_10, _tmp_dvx_10, _tmp_dvx_10);
          ...
          float _tmp_dvx_11 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_12 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_12, _tmp_dvx_12, _tmp_dvx_12), float3(_tmp_dvx_11, _tmp_dvx_11, _tmp_dvx_11))) * _InDirectLightIntensity));
          float3 tmpvar_59;
