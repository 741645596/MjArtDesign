...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_23 = tmpvar_24;
          float4 tmpvar_25;
          float _tmp_dvx_70 = texCUBE(custom_SpecCube, R_23);
          tmpvar_25 = float4(_tmp_dvx_70, _tmp_dvx_70, _tmp_dvx_70, _tmp_dvx_70);
          ...
          float3 tmpvar_48;
          float _tmp_dvx_71 = ((tmpvar_37 * 0.5) + 0.5);
          tmpvar_48 = float3(_tmp_dvx_71, _tmp_dvx_71, _tmp_dvx_71);
          ...
          float _tmp_dvx_72 = clamp(pow((1 - tmpvar_41), 5), 0, 1);
          float _tmp_dvx_73 = clamp((tmpvar_9 + (1 - tmpvar_19)), 0, 1);
          col_30 = (col_30 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_26.w - 1)) + 1)) * data_26.xyz)) * (1 - ((0.28 * roughness_34) * perceptualRoughness_35))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_18, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_73, _tmp_dvx_73, _tmp_dvx_73), float3(_tmp_dvx_72, _tmp_dvx_72, _tmp_dvx_72))) * _InDirectLightIntensity));
          float3 tmpvar_60;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_74 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_74, _tmp_dvx_74, _tmp_dvx_74, _tmp_dvx_74);
          ...
          float3 tmpvar_47;
          float _tmp_dvx_75 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_75, _tmp_dvx_75, _tmp_dvx_75);
          ...
          float _tmp_dvx_76 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_77 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_77, _tmp_dvx_77, _tmp_dvx_77), float3(_tmp_dvx_76, _tmp_dvx_76, _tmp_dvx_76))) * _InDirectLightIntensity));
          float3 tmpvar_59;
