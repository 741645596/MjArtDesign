  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 tmpvar_38;
          float _tmp_dvx_116 = (max((tex2DNode110_8.x - 0.6), 0) / 0.4);
          float _tmp_dvx_117 = (tex2DNode180_7.w * _AddTexOpacity);
          float _tmp_dvx_118 = ceil((tex2DNode110_8.x - 0.1));
          tmpvar_38 = lerp(lerp(lerp(lerp(lerp(lerp(tmpvar_28, tmpvar_29, float4(_tmp_dvx_118, _tmp_dvx_118, _tmp_dvx_118, _tmp_dvx_118)), tex2DNode180_7, float4(_tmp_dvx_117, _tmp_dvx_117, _tmp_dvx_117, _tmp_dvx_117)), lerp(lerp(tmpvar_33, float4(1, 1, 1, 1), (tmpvar_34 / (1 - tmpvar_34))), tmpvar_33, _Back2Color.wwww), float4(_tmp_dvx_116, _tmp_dvx_116, _tmp_dvx_116, _tmp_dvx_116)), tmpvar_35, tex2DNode110_8.yyyy), tmpvar_36, tex2DNode110_8.zzzz), tmpvar_37, tex2DNode110_8.wwww);
          float4 tmpvar_39;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float tmpvar_9;
          float _tmp_dvx_119 = dot(lightCoord_4, lightCoord_4);
          tmpvar_9 = tex2D(_LightTexture0, float2(_tmp_dvx_119, _tmp_dvx_119)).w;
          atten_3 = tmpvar_9;
          ...
          float4 tmpvar_43;
          float _tmp_dvx_120 = (max((tex2DNode110_12.x - 0.6), 0) / 0.4);
          float _tmp_dvx_121 = (tex2DNode180_11.w * _AddTexOpacity);
          float _tmp_dvx_122 = ceil((tex2DNode110_12.x - 0.1));
          tmpvar_43 = lerp(lerp(lerp(lerp(lerp(lerp(tmpvar_33, tmpvar_34, float4(_tmp_dvx_122, _tmp_dvx_122, _tmp_dvx_122, _tmp_dvx_122)), tex2DNode180_11, float4(_tmp_dvx_121, _tmp_dvx_121, _tmp_dvx_121, _tmp_dvx_121)), lerp(lerp(tmpvar_38, float4(1, 1, 1, 1), (tmpvar_39 / (1 - tmpvar_39))), tmpvar_38, _Back2Color.wwww), float4(_tmp_dvx_120, _tmp_dvx_120, _tmp_dvx_120, _tmp_dvx_120)), tmpvar_40, tex2DNode110_12.yyyy), tmpvar_41, tex2DNode110_12.zzzz), tmpvar_42, tex2DNode110_12.wwww);
          float4 tmpvar_44;
          float _tmp_dvx_123 = max(max(ase_lightAttenRGB_16.x, ase_lightAttenRGB_16.y), ase_lightAttenRGB_16.z);
          tmpvar_44 = lerp((tmpvar_43 * _ShadowColor), tmpvar_43, float4(_tmp_dvx_123, _tmp_dvx_123, _tmp_dvx_123, _tmp_dvx_123));
    ...
    Pass // ind: 3, name: META
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          if(unity_MetaFragmentControl.x)
          {
              res_2.w = 1;
              float3 tmpvar_3;
              float _tmp_dvx_124 = clamp(unity_OneOverOutputBoost, 0, 1);
              tmpvar_3 = clamp(pow(float3(0, 0, 0), float3(_tmp_dvx_124, _tmp_dvx_124, _tmp_dvx_124)), float3(0, 0, 0), float3(unity_MaxOutputValue, unity_MaxOutputValue, unity_MaxOutputValue));
