...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_23 = tmpvar_24;
          float4 tmpvar_25;
          float _tmp_dvx_196 = texCUBE(custom_SpecCube, R_23);
          tmpvar_25 = float4(_tmp_dvx_196, _tmp_dvx_196, _tmp_dvx_196, _tmp_dvx_196);
          ...
          float3 tmpvar_48;
          float _tmp_dvx_197 = ((tmpvar_37 * 0.5) + 0.5);
          tmpvar_48 = float3(_tmp_dvx_197, _tmp_dvx_197, _tmp_dvx_197);
          ...
          float _tmp_dvx_198 = clamp(pow((1 - tmpvar_41), 5), 0, 1);
          float _tmp_dvx_199 = clamp((tmpvar_9 + (1 - tmpvar_19)), 0, 1);
          col_30 = (col_30 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_26.w - 1)) + 1)) * data_26.xyz)) * (1 - ((0.28 * roughness_34) * perceptualRoughness_35))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_18, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_199, _tmp_dvx_199, _tmp_dvx_199), float3(_tmp_dvx_198, _tmp_dvx_198, _tmp_dvx_198))) * _InDirectLightIntensity));
          float3 tmpvar_60;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_200 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_200, _tmp_dvx_200, _tmp_dvx_200, _tmp_dvx_200);
          ...
          float3 tmpvar_47;
          float _tmp_dvx_201 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_201, _tmp_dvx_201, _tmp_dvx_201);
          ...
          float _tmp_dvx_202 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_203 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_203, _tmp_dvx_203, _tmp_dvx_203), float3(_tmp_dvx_202, _tmp_dvx_202, _tmp_dvx_202))) * _InDirectLightIntensity));
          float3 tmpvar_59;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_204 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_204, _tmp_dvx_204, _tmp_dvx_204, _tmp_dvx_204);
          envSample_21 = tmpvar_24;
          float4 data_25;
          data_25 = envSample_21;
          float3 normal_26;
          ...
          roughness_33 = tmpvar_45;
          float3 tmpvar_47;
          float _tmp_dvx_205 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_205, _tmp_dvx_205, _tmp_dvx_205);
          diffuseTerm_32 = tmpvar_47;
          float tmpvar_48;
          float NdotL_49;
          NdotL_49 = tmpvar_36;
          ...
          rimLightDirection_28 = in_f.xlv_TEXCOORD9;
          col_29 = (((clamp(tmpvar_4, 0, 1) * (((_GiColor * _IndirectDiffuseIntensity) * _MetallicMapIndirectDiffuseIntensity).xyz + (diffuseTerm_32 * _DirectLightIntensity))) + ((max(0, ((V_31 * D_30) * (3.141593 * tmpvar_36))) * (tmpvar_57 + ((1 - tmpvar_57) * ((x_58 * x_58) * ((x_58 * x_58) * x_58))))) * _DirectSpecularScale)) + clamp(((_RimColor.xyz * clamp(pow(((1 - tmpvar_36) * clamp(dot(normal_26, rimLightDirection_28), 0, 1)), _RimPower), 0, 1)) * _RimIntensity), 0, 1));
          float _tmp_dvx_206 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_207 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_207, _tmp_dvx_207, _tmp_dvx_207), float3(_tmp_dvx_206, _tmp_dvx_206, _tmp_dvx_206))) * _InDirectLightIntensity));
          float3 tmpvar_59;
          tmpvar_59 = lerp((_AOColor.xyz * col_29), col_29, gmVar_5.zzz);
          col_29 = tmpvar_59;
          float4 tmpvar_60;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_208 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_208, _tmp_dvx_208, _tmp_dvx_208, _tmp_dvx_208);
          envSample_21 = tmpvar_24;
          float4 data_25;
          data_25 = envSample_21;
          float3 normal_26;
          ...
          roughness_33 = tmpvar_45;
          float3 tmpvar_47;
          float _tmp_dvx_209 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_209, _tmp_dvx_209, _tmp_dvx_209);
          diffuseTerm_32 = tmpvar_47;
          float tmpvar_48;
          float NdotL_49;
          NdotL_49 = tmpvar_36;
          ...
          rimLightDirection_28 = in_f.xlv_TEXCOORD9;
          col_29 = (((clamp(tmpvar_4, 0, 1) * (((_GiColor * _IndirectDiffuseIntensity) * _MetallicMapIndirectDiffuseIntensity).xyz + (diffuseTerm_32 * _DirectLightIntensity))) + ((max(0, ((V_31 * D_30) * (3.141593 * tmpvar_36))) * (tmpvar_57 + ((1 - tmpvar_57) * ((x_58 * x_58) * ((x_58 * x_58) * x_58))))) * _DirectSpecularScale)) + clamp(((_RimColor.xyz * clamp(pow(((1 - tmpvar_36) * clamp(dot(normal_26, rimLightDirection_28), 0, 1)), _RimPower), 0, 1)) * _RimIntensity), 0, 1));
          float _tmp_dvx_210 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_211 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_211, _tmp_dvx_211, _tmp_dvx_211), float3(_tmp_dvx_210, _tmp_dvx_210, _tmp_dvx_210))) * _InDirectLightIntensity));
          float3 tmpvar_59;
          tmpvar_59 = lerp((_AOColor.xyz * col_29), col_29, gmVar_5.zzz);
          col_29 = tmpvar_59;
          float4 tmpvar_60;
