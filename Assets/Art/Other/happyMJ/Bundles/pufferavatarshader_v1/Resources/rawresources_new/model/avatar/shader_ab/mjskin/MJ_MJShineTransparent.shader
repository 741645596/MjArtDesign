...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 tmpvar_11;
          tmpvar_11 = tex2D(_ShineTex, P_10).xyz;
          tmpvar_9 = tmpvar_11;
          float3 tmpvar_12;
          float3 tmpvar_13;
          tmpvar_13 = normalize(((tex2D(_Bump, in_f.xlv_TEXCOORD0).xyz * 2) - 1));
          tmpvar_12 = tmpvar_13;
          normalInTangent_6 = tmpvar_12;
          float3 tmpvar_14;
          if((tmpvar_1>0))
          {
          ...
          tmpvar_7 = tmpvar_15.w;
          albedo_5 = (tmpvar_15.xyz * _Color.xyz);
          float x_16;
          x_16 = (tmpvar_7 - _cutoff);
          if((x_16<0))
          {
              discard;
          }
          ...
          tmpvar_4 = (albedo_17 * 0.8453586);
          float3 tmpvar_18;
          tmpvar_18 = _LightColor0.xyz;
          float3 normal_19;
          normal_19 = tmpvar_3;
          float3 viewDir_20;
          viewDir_20 = (-in_f.xlv_TEXCOORD5);
          float3 rimLightDirection_21;
          float3 col_22;
          float3 shineColor_23;
          float rotateshine_24;
          float D_25;
          float V_26;
          ...
          float3 h_30;
          float tmpvar_31;
          tmpvar_31 = clamp(dot(normal_19, _WorldSpaceLightPos0.xyz), 0, 1);
          float3 tmpvar_32;
          tmpvar_32 = normalize((_WorldSpaceLightPos0.xyz + viewDir_20));
          h_30 = tmpvar_32;
          float tmpvar_33;
          float tmpvar_34;
          tmpvar_34 = clamp(dot(normal_19, h_30), 0, 1);
          tmpvar_33 = tmpvar_34;
          float tmpvar_35;
          tmpvar_35 = abs(dot(normal_19, viewDir_20));
          float tmpvar_36;
          float tmpvar_37;
          tmpvar_37 = clamp(dot(_WorldSpaceLightPos0.xyz, h_30), 0, 1);
          tmpvar_36 = tmpvar_37;
          float tmpvar_38;
          float smoothness_39;
          ...
          float3 tmpvar_42;
          float _tmp_dvx_291 = ((tmpvar_31 * 0.5) + 0.5);
          tmpvar_42 = float3(_tmp_dvx_291, _tmp_dvx_291, _tmp_dvx_291);
          ...
          x_53 = (1 - tmpvar_36);
          float3 tmpvar_54;
          float _tmp_dvx_292 = ((max(0, ((V_26 * D_25) * (3.141593 * tmpvar_31))) * (tmpvar_52 + ((1 - tmpvar_52) * ((x_53 * x_53) * ((x_53 * x_53) * x_53))))) * _DirectSpecularScale);
          tmpvar_54 = float3(_tmp_dvx_292, _tmp_dvx_292, _tmp_dvx_292);
          float tmpvar_55;
          tmpvar_55 = ((((((-viewDir_20.x) + viewDir_20.y) - viewDir_20.z) * _RotateRate) + tmpvar_9.x) + (_Time.x * _ShineSpeed));
          rotateshine_24 = tmpvar_55;
          float tmpvar_56;
          tmpvar_56 = (tmpvar_9.y * 2);
          float _tmp_dvx_293 = clamp((tmpvar_56 - 1), 0, 1);
          float _tmp_dvx_294 = clamp(tmpvar_56, 0, 1);
          shineColor_23 = (lerp(lerp(_DiamondCol.xyz, _DiamondCol2.xyz, float3(_tmp_dvx_294, _tmp_dvx_294, _tmp_dvx_294)), _DiamondCol3.xyz, float3(_tmp_dvx_293, _tmp_dvx_293, _tmp_dvx_293)) * ((pow(clamp((pow(((frac((rotateshine_24 + tmpvar_9.x)) * tmpvar_9.z) - _Mask), 3) * _ShineIntensity), 0, 1), _FracPower) * tmpvar_9.z) * _ShineIntensity2));
          shineColor_23 = ((tmpvar_54 * pow(tmpvar_33, lerp(_Power1, _Power2, clamp(dot(_WorldSpaceLightPos0.xyz, viewDir_20), 0, 1)))) * shineColor_23);
          rimLightDirection_21 = in_f.xlv_TEXCOORD9;
          col_22 = (((clamp(tmpvar_4, 0, 1) * ((_GiColor * _IndirectDiffuseIntensity).xyz + (diffuseTerm_27 * _DirectLightIntensity))) + tmpvar_54) + clamp(((_RimColor.xyz * clamp(pow(((1 - tmpvar_31) * clamp(dot(normal_19, rimLightDirection_21), 0, 1)), _RimPower), 0, 1)) * _RimIntensity), 0, 1));
          col_22 = (col_22 + shineColor_23);
          float4 tmpvar_57;
          tmpvar_57.xyz = float3(((col_22 * tmpvar_7) * tmpvar_18));
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 rimLightDirection_20;
          float3 col_21;
          float3 shineColor_22;
          float rotateshine_23;
          float D_24;
          float V_25;
          ...
          float3 h_29;
          float tmpvar_30;
          tmpvar_30 = clamp(dot(normal_18, _WorldSpaceLightPos0.xyz), 0, 1);
          float3 tmpvar_31;
          tmpvar_31 = normalize((_WorldSpaceLightPos0.xyz + viewDir_19));
          h_29 = tmpvar_31;
          float tmpvar_32;
          float tmpvar_33;
          tmpvar_33 = clamp(dot(normal_18, h_29), 0, 1);
          tmpvar_32 = tmpvar_33;
          float tmpvar_34;
          tmpvar_34 = abs(dot(normal_18, viewDir_19));
          float tmpvar_35;
          float tmpvar_36;
          ...
          float3 tmpvar_41;
          float _tmp_dvx_295 = ((tmpvar_30 * 0.5) + 0.5);
          tmpvar_41 = float3(_tmp_dvx_295, _tmp_dvx_295, _tmp_dvx_295);
          ...
          x_52 = (1 - tmpvar_35);
          float3 tmpvar_53;
          float _tmp_dvx_296 = ((max(0, ((V_25 * D_24) * (3.141593 * tmpvar_30))) * (tmpvar_51 + ((1 - tmpvar_51) * ((x_52 * x_52) * ((x_52 * x_52) * x_52))))) * _DirectSpecularScale);
          tmpvar_53 = float3(_tmp_dvx_296, _tmp_dvx_296, _tmp_dvx_296);
          float tmpvar_54;
          tmpvar_54 = ((((((-viewDir_19.x) + viewDir_19.y) - viewDir_19.z) * _RotateRate) + tmpvar_9.x) + (_Time.x * _ShineSpeed));
          rotateshine_23 = tmpvar_54;
          float tmpvar_55;
          tmpvar_55 = (tmpvar_9.y * 2);
          float _tmp_dvx_297 = clamp((tmpvar_55 - 1), 0, 1);
          float _tmp_dvx_298 = clamp(tmpvar_55, 0, 1);
          shineColor_22 = (lerp(lerp(_DiamondCol.xyz, _DiamondCol2.xyz, float3(_tmp_dvx_298, _tmp_dvx_298, _tmp_dvx_298)), _DiamondCol3.xyz, float3(_tmp_dvx_297, _tmp_dvx_297, _tmp_dvx_297)) * ((pow(clamp((pow(((frac((rotateshine_23 + tmpvar_9.x)) * tmpvar_9.z) - _Mask), 3) * _ShineIntensity), 0, 1), _FracPower) * tmpvar_9.z) * _ShineIntensity2));
          shineColor_22 = ((tmpvar_53 * pow(tmpvar_32, lerp(_Power1, _Power2, clamp(dot(_WorldSpaceLightPos0.xyz, viewDir_19), 0, 1)))) * shineColor_22);
          rimLightDirection_20 = in_f.xlv_TEXCOORD9;
          col_21 = (((clamp(tmpvar_4, 0, 1) * ((_GiColor * _IndirectDiffuseIntensity).xyz + (diffuseTerm_26 * _DirectLightIntensity))) + tmpvar_53) + clamp(((_RimColor.xyz * clamp(pow(((1 - tmpvar_30) * clamp(dot(normal_18, rimLightDirection_20), 0, 1)), _RimPower), 0, 1)) * _RimIntensity), 0, 1));
          col_21 = (col_21 + shineColor_22);
          float4 tmpvar_56;
          tmpvar_56.xyz = float3(((col_21 * tmpvar_7) * tmpvar_17));
          tmpvar_56.w = tmpvar_7;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          roughness_27 = tmpvar_39;
          float3 tmpvar_41;
          float _tmp_dvx_299 = ((tmpvar_30 * 0.5) + 0.5);
          tmpvar_41 = float3(_tmp_dvx_299, _tmp_dvx_299, _tmp_dvx_299);
          diffuseTerm_26 = tmpvar_41;
          float tmpvar_42;
          float NdotL_43;
          NdotL_43 = tmpvar_30;
          ...
          x_52 = (1 - tmpvar_35);
          float3 tmpvar_53;
          float _tmp_dvx_300 = ((max(0, ((V_25 * D_24) * (3.141593 * tmpvar_30))) * (tmpvar_51 + ((1 - tmpvar_51) * ((x_52 * x_52) * ((x_52 * x_52) * x_52))))) * _DirectSpecularScale);
          tmpvar_53 = float3(_tmp_dvx_300, _tmp_dvx_300, _tmp_dvx_300);
          float tmpvar_54;
          tmpvar_54 = ((((((-viewDir_19.x) + viewDir_19.y) - viewDir_19.z) * _RotateRate) + tmpvar_9.x) + (_Time.x * _ShineSpeed));
          rotateshine_23 = tmpvar_54;
          float tmpvar_55;
          tmpvar_55 = (tmpvar_9.y * 2);
          float _tmp_dvx_301 = clamp((tmpvar_55 - 1), 0, 1);
          float _tmp_dvx_302 = clamp(tmpvar_55, 0, 1);
          shineColor_22 = (lerp(lerp(_DiamondCol.xyz, _DiamondCol2.xyz, float3(_tmp_dvx_302, _tmp_dvx_302, _tmp_dvx_302)), _DiamondCol3.xyz, float3(_tmp_dvx_301, _tmp_dvx_301, _tmp_dvx_301)) * ((pow(clamp((pow(((frac((rotateshine_23 + tmpvar_9.x)) * tmpvar_9.z) - _Mask), 3) * _ShineIntensity), 0, 1), _FracPower) * tmpvar_9.z) * _ShineIntensity2));
          shineColor_22 = ((tmpvar_53 * pow(tmpvar_32, lerp(_Power1, _Power2, clamp(dot(_WorldSpaceLightPos0.xyz, viewDir_19), 0, 1)))) * shineColor_22);
          rimLightDirection_20 = in_f.xlv_TEXCOORD9;
          col_21 = (((clamp(tmpvar_4, 0, 1) * ((_GiColor * _IndirectDiffuseIntensity).xyz + (diffuseTerm_26 * _DirectLightIntensity))) + tmpvar_53) + clamp(((_RimColor.xyz * clamp(pow(((1 - tmpvar_30) * clamp(dot(normal_18, rimLightDirection_20), 0, 1)), _RimPower), 0, 1)) * _RimIntensity), 0, 1));
          col_21 = (col_21 + shineColor_22);
