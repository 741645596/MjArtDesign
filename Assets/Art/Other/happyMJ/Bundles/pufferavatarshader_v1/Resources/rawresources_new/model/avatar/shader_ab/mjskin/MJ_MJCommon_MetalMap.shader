...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_244 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_244, _tmp_dvx_244, _tmp_dvx_244, _tmp_dvx_244);
          ...
          float3 tmpvar_49;
          float _tmp_dvx_245 = ((tmpvar_38 * 0.5) + 0.5);
          tmpvar_49 = float3(_tmp_dvx_245, _tmp_dvx_245, _tmp_dvx_245);
          ...
          float _tmp_dvx_246 = clamp(pow((1 - tmpvar_42), 5), 0, 1);
          float _tmp_dvx_247 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_31 = (col_31 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_35) * perceptualRoughness_36))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_247, _tmp_dvx_247, _tmp_dvx_247), float3(_tmp_dvx_246, _tmp_dvx_246, _tmp_dvx_246))) * _InDirectLightIntensity));
          float3 tmpvar_61;
...
#pragma exclude_renderers d3d11
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          R_22 = tmpvar_23;
          float4 tmpvar_24;
          float _tmp_dvx_248 = texCUBE(custom_SpecCube, R_22);
          tmpvar_24 = float4(_tmp_dvx_248, _tmp_dvx_248, _tmp_dvx_248, _tmp_dvx_248);
          envSample_21 = tmpvar_24;
          float4 data_25;
          data_25 = envSample_21;
          float3 normal_26;
          ...
          float3 tmpvar_47;
          float _tmp_dvx_249 = ((tmpvar_36 * 0.5) + 0.5);
          tmpvar_47 = float3(_tmp_dvx_249, _tmp_dvx_249, _tmp_dvx_249);
          ...
          float _tmp_dvx_250 = clamp(pow((1 - tmpvar_40), 5), 0, 1);
          float _tmp_dvx_251 = clamp((tmpvar_9 + (1 - tmpvar_18)), 0, 1);
          col_29 = (col_29 + ((((tmpvar_10 * ((unity_SpecCube0_HDR.x * ((unity_SpecCube0_HDR.w * (data_25.w - 1)) + 1)) * data_25.xyz)) * (1 - ((0.28 * roughness_33) * perceptualRoughness_34))) * lerp(lerp(float3(0.2209163, 0.2209163, 0.2209163), albedo_17, float3(tmpvar_10, tmpvar_10, tmpvar_10)), float3(_tmp_dvx_251, _tmp_dvx_251, _tmp_dvx_251), float3(_tmp_dvx_250, _tmp_dvx_250, _tmp_dvx_250))) * _InDirectLightIntensity));
          float3 tmpvar_59;
