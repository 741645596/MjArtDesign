#ifndef UNIVERSAL_SSS_LIGHTING_INCLUDED
#define UNIVERSAL_SSS_LIGHTING_INCLUDED
...
half3 LightingPhysicallyBased(BRDFData brdfData, 
    ...
    half3 normalWS, half3 viewDirectionWS,
    bool specularHighlightsOff, float specularStrength)
{
    ...
    [branch] if (!specularHighlightsOff)
    {
        brdf += brdfData.specular * DirectBRDFSpecular(brdfData, normalWS, lightDirectionWS, viewDirectionWS) * specularStrength;
    }
...
half3 LightingPhysicallyBased(BRDFData brdfData,
    ...
    bool specularHighlightsOff, float specularStrength)
{
    return LightingPhysicallyBased(brdfData, light.color, light.direction, light.distanceAttenuation, normalWS, viewDirectionWS, specularHighlightsOff, specularStrength);
}
...
///////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentPBR(InputData inputData, SurfaceData surfaceData, float specularStrength)
{
    ...
    color += LightingPhysicallyBased(brdfData,
                                     mainLight,
                                     inputData.normalWS, inputData.viewDirectionWS,
                                     specularHighlightsOff, specularStrength);
...
half4 UniversalFragmentPBR(InputData inputData, half3 albedo, half metallic, half3 specular,
    half smoothness, half occlusion, half3 emission, half alpha, float specularStrength)
{
    SurfaceData s;
    s.albedo              = albedo;
    s.metallic            = metallic;
    ...
    return UniversalFragmentPBR(inputData, s, specularStrength);
}
