#ifndef UNIVERSAL_DZZ_EYE_LIGHTING_INCLUDED
#define UNIVERSAL_DZZ_EYE_LIGHTING_INCLUDED
    ...
    half3 _AmbientColor)
{
    ...
    // 修改的地方
    half3 indirectDiffuse =  occlusion * _AmbientColor;
...
half3 LightingPhysicallyBased(BRDFData brdfData,
    ...
    bool specularHighlightsOff)
{
    return LightingPhysicallyBased(brdfData, light.color, light.direction, light.distanceAttenuation, normalWS, viewDirectionWS, specularHighlightsOff);
}
    ...
    half3 _AmbientColor)
{
    ...
    return UniversalFragmentPBR(inputData, s, _AmbientColor);
}
