    ...
    ,half _GlobalCubemapRotation, half _GlobalCubemapIntensity)
{
    ...
    half3 indirectSpecular = GlossyEnvironmentReflection(reflectVector, brdfData.perceptualRoughness, occlusion) * _GlobalCubemapIntensity;
    ...
    half3 _AmbientCol)
{
    ...
    return UniversalFragmentPBR(inputData, s, _GlobalBackfaceBrightness, _GlobalCubemapRotation, _GlobalCubemapIntensity, _AmbientCol);
}
