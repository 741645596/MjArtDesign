...
namespace EditerUtils
{
    ...
    public static class FileHelper
    {
        ...
        public static bool Move(string oldFilePath, string newFilePath)
        {
            ...
            // 确保目标文件夹存在
            var newDir = PathHelper.GetDirectoryName(newFilePath);
            ...
            {
                Debug.LogError($"错误提示：重命名{oldFilePath}文件替换为{newFilePath}，抛出异常{e}");
                return false;
            }
        }
        ...
        public static bool Rename(string filePath, string newName)
        {
            ...
            var dir = PathHelper.GetDirectoryName(filePath);
        ...
        public static bool Copy(string currentPath, string targetPath)
        {
            ...
            // 确保目标文件夹存在
            var newDir = PathHelper.GetDirectoryName(targetPath);
            DirectoryHelper.CreateDirectory(newDir);
